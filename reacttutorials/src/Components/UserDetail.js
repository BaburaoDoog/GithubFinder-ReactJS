...
export const UserDetail =(props)=>{
    ...
    useEffect(()=>{
        props.getUserDetails(props.match.params.anything)
        ...
        Hireable:{props.user.hiberable ? (
          ...
          <div className="card grid-2">
              ...
              <div>
                  ...
                  <a href={props.user.html_url} className="btn btn-dark my-1">Visit github profiles</a>
                  <ul>
                      <li>
                          {props.user.company && (
                              <>
                              <strong>Company name :{props.user.company}</strong>
                              </>
                          )}
                      </li>
                      <li>
